export type PropertyType = "Casa" | "Apartamento" | "Local" | "Galpón" | "Terreno" | "Oficina" | "TownHouse" | "Edificio";
...
// Real property data scraped from regaladogroup.net
import { scrapedProperties } from './scraped_properties';
export const properties: Property[] = scrapedProperties;
